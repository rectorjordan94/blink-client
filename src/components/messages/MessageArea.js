            ...
            <div className="container w-75 d-flex justify-content-center align-items-center" id="info-container">
                <div className="card mx-5" id="info-card">
                    ...
                    <div className="card-body" id="info-body">
                        ...
                        <p className="card-text">This is a project built with the MERN stack, using the MVC system for organizing the code. To view this project's code or to see any of my other projects click <a href="https://github.com/rectorjordan94" className="info-spans">here</a>.</p>
                    </div>
